//original_plugin/src/rviz/overlay/log_display.cpp
#include "ros118.h"
...
ros118::ros118()
{
  ...
  log_sub_ = nh_.subscribe("/rosout", 10, &ros118::processMessage, this);
}
...
void ros118::save(rviz::Config config) const
{
...
void ros118::load(const rviz::Config& config)
{
...
Ogre::TextAreaOverlayElement* ros118::createTextElement(int index)
{
...
void ros118::processMessage(const rosgraph_msgs::Log& msg)
{
...
void ros118::createMaterial(std::string mat_name)
{
  int width = 100;
  int height = 100;
...
void ros118::destroyMaterial(std::string mat_name)
{
  std::string texture_name = mat_name + "Texture";
...
PLUGINLIB_EXPORT_CLASS(original_plugin::ros118, rviz::Display)